...
*/
package com.premsinghdaksha.deviceinformationlibrary.deviceinfo.device;
...
//        return IMEI;
        ...
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            if (mTelephony.getSubscriberId() != null) {
                IMEI = mTelephony.getSubscriberId();
            } else {
...
//        return telephonyManager.getSimSerialNumber();
        ...
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            SimSerialNumber = Settings.Secure.getString(context.getContentResolver(), Settings.Secure.ANDROID_ID);
            ...
            if (mTelephony.getSimSerialNumber() != null) {
                SimSerialNumber = mTelephony.getSimSerialNumber();
            } else {
